...
import os
from controlnet_fused_avg import forwardfused
...
@torch.no_grad()
def diffusion_step(model, latents, context, t, guidance_scale, control1=None,control2=None, low_resource=False):
...
def text2image_ldm_stable(
    ...
    for t in tqdm(model.scheduler.timesteps):
        latents = diffusion_step(model, latents, context, t, guidance_scale, control1=control1,control2=control2,low_resource = low_resource)
